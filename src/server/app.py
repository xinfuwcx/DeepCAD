...
# 从各模块导入路由
from src.api.routes import modeling_router, mesh_router, compute_router, visualization_router, ai_router, excavation_router
...
api_router.include_router(mesh_router.router, prefix="/mesh", tags=["网格划分"])
...
api_router.include_router(ai_router.router, prefix="/ai", tags=["物理AI"])

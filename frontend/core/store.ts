...
export interface GeologicalLayer {
  ...
  color: string;
  opacity: number;
  geometry?: ThreeJsGeometry; // Make geometry optional for lightweight model
}
...
export interface AppState {
    ...
    geologicalModel: GeologicalModel | null;
    ...
    setGeologicalModel: (modelData: GeologicalModel | null) => void;

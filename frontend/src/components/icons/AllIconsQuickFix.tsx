...
export const RetainingWallIcon: React.FC<IconProps> = ({ size, ...props }) => (
  <SimpleIcon size={size || 24} {...props}>
    <g stroke="currentColor" strokeWidth="1.5" fill="none">
      <rect x="4" y="6" width="4" height="16" />
      <path d="M8 6L16 2v20L8 22" />
      <line x1="10" y1="8" x2="14" y2="6" />
      <line x1="10" y1="12" x2="14" y2="10" />
      <line x1="10" y1="16" x2="14" y2="14" />
    </g>
  </SimpleIcon>
);
...
export const CompletedIcon: React.FC<IconProps> = ({ size, ...props }) => (
  <SimpleIcon size={size || 24} {...props}>
    <g stroke="currentColor" strokeWidth="1.5" fill="none">
...
export const ProcessingIcon: React.FC<IconProps> = ({ size, ...props }) => (
  <SimpleIcon size={size || 24} {...props}>
    <g stroke="currentColor" strokeWidth="1.5" fill="none">
      <circle cx="12" cy="12" r="10" />
      <path d="M12 6v6l4 2" />
...
export const ErrorIcon: React.FC<IconProps> = ({ size, ...props }) => (
  <SimpleIcon size={size || 24} {...props}>
    <g stroke="currentColor" strokeWidth="1.5" fill="none">
      <circle cx="12" cy="12" r="10" />

    ...
    <Card title="测量结果" style={{ width: 350, maxHeight: 400, overflow: 'auto' }}>
      {measurements.length === 0 ? (
        <div className="text-center text-secondary py-4">
          <RulerOutlined className="text-2xl mb-2" />
          <div>暂无测量结果</div>
    ...
    <div className="interaction-toolbar">
      ...
      <GlassCard variant="subtle" className="p-2">
        <Space direction="vertical" size="small">
          ...
          {/* 信息和设置 */}
          <div className="space-y-1">
            <Dropdown overlay={measurementMenu} trigger={['click']} placement="leftTop">
              <GlassButton
                variant="ghost"
                size="sm"
                icon={<RulerOutlined />}
            ...
            <Dropdown overlay={annotationMenu} trigger={['click']} placement="leftTop">
              <GlassButton
                variant="ghost"
                size="sm"
                icon={<CommentOutlined />}
            ...
            <Dropdown overlay={settingsPanel} trigger={['click']} placement="leftTop">
              <GlassButton
                variant="ghost"
                size="sm"

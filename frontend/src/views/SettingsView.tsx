/**
 * SettingsView.tsx - 系统设置配置中心
 * 
 * 功能描述:
 * - 系统全局设置和配置管理界面
 * - 涵盖界面、性能、网络、CAE专业、工程规范等多个设置类别
 * - 专门针对深基坑CAE系统的专业参数配置
 * - 支持设置的保存、重置和实时预览
 * 
 * 设置类别:
 * 1. 界面设置 - 主题、语言、显示选项、快捷键配置
 * 2. 性能设置 - 渲染质量、线程数、缓存大小、自动保存
 * 3. 网络设置 - API服务器、超时时间、代理配置
 * 4. CAE专业设置 - 求解器选择、网格质量、分析类型
 * 5. 工程规范设置 - 设计规范、材料数据库、安全系数
 * 6. 计算设置 - GPU加速、并行计算、内存限制、收敛精度
 * 7. 高级设置 - 调试模式、实验性功能、错误报告
 * 
 * 专业特色:
 * - 支持多种深基坑设计规范 (JGJ120-2012, GB50007-2011等)
 * - 集成Kratos、Plaxis、Abaqus等专业求解器
 * - 提供中国标准材料库和工程安全系数配置
 * 
 * 技术特点: 分类管理、实时验证、配置持久化
 */

 ...
 * 
 * 地质建模功能:
 * 1. 钻孔数据管理 - 钻孔位置、深度、土层信息录入
 * 2. 地层插值建模 - 基于钻孔数据建立连续地质模型
 * 3. 土性参数配置 - 各土层的物理力学参数设置
 * 4. 地下水位设置 - 地下水位线和渗透系数配置
 * 5. 地质剖面生成 - 自动生成地质横断面和纵断面
 * 
 * 可视化特性:
 * - SoilDomainCanvas2D: 2D地质剖面绘制
 * - GeologyThreeViewer: 3D地质体可视化
 * - 分层着色显示不同土层特性
 * - 钻孔位置和地层边界标注
 * 
 * 数据管理:
 ...
 * - 地质模型导出为CAE分析格式
 * 
 * 技术栈: React + Three.js + Canvas2D + 地质插值算法
 */
